...
<body id="itemsBody">
    <nav id="amazonNav">
        ...
        <div class="dropdown-content">
            ...
            <a href="upload_item.php">Add Items</a>
...
<section id="UploadDIv">
    <h1>Upload Items</h1>
<form class="style_form" id="upload_item" onsubmit="return false" enctype="multipart/form-data">
...
<div>
  ...
  <input name="item_price" type="number" placeholder="Item Price (DKK)">
</div>
<div>
  <label for="itemInstock">Items in Stock</label>
  <input name="item_stock" type="number" placeholder="Item Instock">
</div>
<br>
<div>
