...
<main id="Account">
    ...
    <div id="yourAccount">
        <section class="accountSection">
            ...
            <a href="../update_items/update_item.php">Your Items</a>
            <p class="smallerText">Add Items, Update Items, View Items</p>
        </section>

        <section class="accountSection">
            <img src="../image/lock.png" id="box">
            <a href="../update_profile/update_profile.php">Login &amp; Security</a>
            <p class="smallerText">Edit name, email, and password</p>
        </section>
        ...
        <section class="accountSection">
            ...
            <p>Your Addresses</p>
            <p class="smallerText">Edit addresses and Delivery</p>
        </section>
        <section class="accountSection">
            <img src="../image/card.png" id="box">
            <p>Your Paymenets</p>
            <p class="smallerText">Manage payment methods and settings</p>
        </section>
        <section class="accountSection">
            <img src="../image/gift_card.png" id="box">
            <p>Gift card &amp; Top up</p>
            <p class="smallerText">View Balance</p>
        </section>
